<x-layout>
    ...
    <div class="container mx-auto p-5 bg-gray-200 rounded-3xl">
        <div class="items-center mb-3">
            ...
            <p class="text-sm ps-8"> You cannot add an instructor without first adding a course. Please add courses first.</p>
        </div>
                ...
                <tbody>
                    @foreach ($instructors as $instructor)
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="py-2 px-4 text-center border-b">{{ $instructor->course->course_name }}</td>
